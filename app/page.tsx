...
export default function Home() {
  return (
    <main className="relative flex flex-1 flex-col">
      ...
      <header className="relative flex items-center justify-between border-b border-border px-8 py-5 sm:px-12 lg:px-16">
        <svg
          aria-hidden
          viewBox="0 0 20 20"
      ...
      <div className="relative flex flex-1 items-end px-8 pb-12 pt-28 sm:px-12 lg:px-16">
        <div className="flex w-full flex-col gap-10 xl:flex-row xl:items-end xl:justify-between xl:gap-20">
          ...
          <p className="max-w-xs text-sm leading-6 text-muted-foreground xl:pb-4 xl:text-right">
      ...
      <footer className="relative flex items-center justify-between border-t border-border px-8 py-5 font-mono text-[0.72rem] tracking-[0.06em] text-muted-foreground sm:px-12 lg:px-16">
        <span>2026</span>
        <span>gridd.app</span>
      </footer>
    </main>
